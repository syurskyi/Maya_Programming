...
class TabWidgetDialog(QtWidgets.QDialog):
    ...
    WINDOW_TITLE = "QTabWidget Example"
...
if __name__ == "__main__":
    ...
    try:
        tabwidget_dialog.close() # pylint: disable=E0601
        tabwidget_dialog.deleteLater()
    except:
        pass

    tabwidget_dialog = TabWidgetDialog()
    tabwidget_dialog.show()
